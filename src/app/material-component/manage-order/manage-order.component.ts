...
export class ManageOrderComponent implements OnInit {
  ...
  getCategories() {
    this.categoryService.getFillteredCategory().subscribe((response:any) => {
  ...
  getProductByCategorys(value:any){
  ...
  add(){
    ...
    if(productName === undefined){
      ...
      this.snackbarService.openSnackBar(GlobalConstants.productExitsError,GlobalConstants.error);
    }
  }
